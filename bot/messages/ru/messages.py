...
what_raids_need_to_show = "Какой рейд капитана **{captain}** мне показать? Если лень тыкать, " \
...
user_try_show_raid_from_raids_by_wrong_time = "У капитана **{captain}** много рейдов, но ты указал время отпытия " \
                                              "**{time}**, которого нету у этого капитана. Давай я лучше тебя спрошу " \
                                              "какой из его рейдов показать!"
