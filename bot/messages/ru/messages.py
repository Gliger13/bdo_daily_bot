...
what_raids_need_to_show = "Какой рейд капитана **{captain}** мне использовать? Если лень тыкать, " \
...
user_try_get_raid_from_raids_by_wrong_time = "У капитана **{captain}** много рейдов, но ты указал время отпытия " \
                                             "**{time}**, которого нету у этого капитана. Давай я лучше тебя спрошу " \
                                             "какой из его рейдов использовать!"
...
user_want_this_raid = "Мне использовать рейд капитана **{captain}** с временем отпытия **{time_leaving}**?"
