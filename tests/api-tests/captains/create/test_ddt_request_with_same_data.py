"""Data Driven Test to check captain create by valid parameters with same data."""
import pytest
...
async def test_ddt_request_with_same_data(test_data: dict, actual_create_captain_response: SimpleResponse) -> None:
    ...
    soft_check_response_json_attributes(
        ...
        {"message": CaptainsAPIMessages.NOT_CHANGED},
