"""Data Driven Test to check captain create by invalid body."""
import pytest
...
async def test_ddt_request_by_invalid_body(test_data: dict, actual_create_captain_response: SimpleResponse) -> None:
    """DDT to check captain create by invalid body.
    ...
    """
    soft_check_response_status_code(actual_create_captain_response, codes.bad_request)
