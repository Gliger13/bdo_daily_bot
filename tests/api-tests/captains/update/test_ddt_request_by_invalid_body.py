"""Data Driven Test to check update by invalid body."""
import pytest
...
async def test_ddt_request_by_invalid_body(test_data: dict, actual_update_captain_response: SimpleResponse) -> None:
    """DDT to check update captain by invalid body.
    ...
    """
    soft_check_response_status_code(actual_update_captain_response, codes.bad_request)
