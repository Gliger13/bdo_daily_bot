...
async def test_ddt_request_by_invalid_id(test_data: dict, actual_get_captain_response: SimpleResponse) -> None:
    """DDT to check get captain by invalid id.
    ...
    """
    soft_check_response_status_code(actual_get_captain_response, codes.bad_request)
