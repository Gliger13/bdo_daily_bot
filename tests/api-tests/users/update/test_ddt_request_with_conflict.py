"""Data Driven Test to check user update by valid body with nickname conflict."""
import pytest
...
async def test_ddt_request_with_conflict(test_data: dict, actual_update_user_response: SimpleResponse) -> None:
    ...
    """
    soft_check_response_status_code(actual_update_user_response, codes.conflict)
