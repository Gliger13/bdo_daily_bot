...
async def test_ddt_request_by_valid_body(test_data: dict, actual_update_user_response: SimpleResponse) -> None:
    ...
    """
    soft_check_response_status_code(actual_update_user_response, codes.ok)
