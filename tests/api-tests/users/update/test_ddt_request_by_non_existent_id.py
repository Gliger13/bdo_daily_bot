...
async def test_ddt_request_by_non_existent_id(test_data: dict, actual_update_user_response: SimpleResponse) -> None:
    """DDT to check update user by non-existent id.
    ...
    """
    soft_check_response_status_code(actual_update_user_response, codes.not_found)
