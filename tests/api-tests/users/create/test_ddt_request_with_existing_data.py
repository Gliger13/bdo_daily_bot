"""Data Driven Test to check user create by valid parameters with user update."""
import pytest
...
async def test_ddt_request_with_existing_data(test_data: dict, actual_create_user_response: SimpleResponse) -> None:
    ...
    soft_check_response_json_attributes(
        ...
        {"message": UsersAPIMessages.USER_UPDATED},
