"""Data Driven Test to check user create by valid body."""
import pytest
...
async def test_ddt_request_by_valid_body(test_data: dict, actual_create_user_response: SimpleResponse) -> None:
    """DDT to check user create by valid body.
    ...
    """
    soft_check_response_status_code(actual_create_user_response, codes.created)
