...
async def test_ddt_request_by_valid_id(test_data: dict, actual_get_user_response: SimpleResponse) -> None:
    ...
    """
    soft_check_response_status_code(actual_get_user_response, codes.ok)
