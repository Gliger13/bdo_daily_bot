...
<<<<<<< Updated upstream:test_framework/asserts/database_asserts/check_settings_collection.py
...
>>>>>>> Stashed changes:tests/test_framework/asserts/database_asserts/check_settings_collection.py
