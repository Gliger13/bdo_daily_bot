...
<<<<<<< Updated upstream:tests/test_database/test_captain_collection/test_get_last_raids.py
...
from tests.test_framework.asserts.database_asserts.check_captain_collection import check_get_last_raids
from tests.test_framework.scripts.common.data_factory import get_test_data
>>>>>>> Stashed changes:tests/tests/test_database/test_captain_collection/test_get_last_raids.py
