...
from tests.test_framework.asserts.database_asserts.check_user_collection import check_user_leave_raid
...
async def test_user_leave_raid(user_collection: UserCollection, test_data: dict):
    ...
    :type test_data: dict
    """
    await check_user_leave_raid(user_collection, test_data)
