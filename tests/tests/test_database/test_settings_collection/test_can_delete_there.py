...
<<<<<<< Updated upstream:tests/test_database/test_settings_collection/test_can_delete_there.py
...
from tests.test_framework.asserts.database_asserts.check_settings_collection import check_can_delete_there
from tests.test_framework.scripts.common.data_factory import get_test_data
>>>>>>> Stashed changes:tests/tests/test_database/test_settings_collection/test_can_delete_there.py
