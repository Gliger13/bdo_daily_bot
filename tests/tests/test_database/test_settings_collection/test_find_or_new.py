...
<<<<<<< Updated upstream:tests/test_database/test_settings_collection/test_find_or_new.py
...
>>>>>>> Stashed changes:tests/tests/test_database/test_settings_collection/test_find_or_new.py
