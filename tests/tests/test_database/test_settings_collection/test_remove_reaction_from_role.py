...
<<<<<<< Updated upstream:tests/test_database/test_settings_collection/test_remove_reaction_from_role.py
...
from tests.test_framework.asserts.database_asserts.check_settings_collection import check_remove_reaction_from_role
from tests.test_framework.scripts.common.data_factory import get_test_data
>>>>>>> Stashed changes:tests/tests/test_database/test_settings_collection/test_remove_reaction_from_role.py
